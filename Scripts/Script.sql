...
alter table courses 
add course_description TEXT;  -- adding course_description column which I had forgotten
...
ADD grades VARCHAR(2);  -- adding gardes column which I had forgotten
...
(14, 14, 101, '2025-01-07', 'A'),
(15, 3,  104, '2025-01-07', 'B'),
(16, 9,  103, '2025-01-07', 'B');
